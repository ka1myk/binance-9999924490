...
def update_portfolio(orders, last_price, volume):
    ...
    for coin in orders:
        ...
        avgPriceBTCUSDT_buy = float(client.get_avg_price(symbol='BTCUSDT')['price'])
        klines_info = client.get_klines(symbol=SYMBOL, interval=MY_FIRST_INTERVAL)
        ...
        coins_bought[coin] = {
            ...
            'avgPriceBTCUSDT_buy':avgPriceBTCUSDT_buy,
            'volume_of_BTC_buy': klines_info[0][5],
            'trades_of_BTC_buy': klines_info[0][8],
            }
