...
from custsignalmod import OSC_INDICATORS, OSC_THRESHOLD, MA_INDICATORS, MA_THRESHOLD
...
if __name__ == '__main__':
    ...
    bot_token = str(parsed_creds['bot_token'])
    bot_chatID = str(parsed_creds['bot_chatID'])
